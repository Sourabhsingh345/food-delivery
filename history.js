...
.then(data => {
    ...
    data.forEach(order => {
        ...
        <div class="food-card" style="width:320px; display:inline-block; margin:15px; text-align:left;">
            ...
            onclick="window.location.href='track.html?id=${order._id}'"
            style="margin-top:12px; width:100%; padding:10px; background:linear-gradient(135deg,#ff9800,#ff5722); color:white; border:none; border-radius:6px; cursor:pointer; font-weight:bold;">
            Track Order 🛵
            </button>
